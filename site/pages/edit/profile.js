...
const profile = () => {
  ...
  const saveProfile = (e) => {
    e.preventDefault();
    fetch(`https://link-ripple-backend.onrender.com/save/profile`, {
      method: "POST",
      headers: {
  ...
  const saveSocials = (e) => {
    e.preventDefault();
    fetch(`https://link-ripple-backend.onrender.com/save/socials`, {
      method: "POST",
      headers: {
        "Content-type": "application/json"
      },
  ...
  useEffect(() => {
    ...
    fetch(`https://link-ripple-backend.onrender.com/load/socials`, {
      method: "POST",
      headers: {
        "Content-type": "application/json"
      },
